...
namespace eCommerce.Domain.Entities
{
    public class ShippingRateRule : BaseEntity
    {
        ...
        public ShippingZone OriginShippingZone { get; set; } = null!;

        public int DestinationShippingZoneId { get; set; }
        public ShippingZone DestinationShippingZone { get; set; } = null!;
        // Mức độ dịch vụ
        public int ShippingServiceLevelId { get; set; }
        public ShippingServiceLevel ShippingServiceLevel { get; set; } = null!;
        ...
        public GlobalShippingLane? GlobalShippingLane { get; set; }
        ...
        public ICollection<ShippingRateTier>? ShippingRateTiers { get; set; }
